package com.fit.se.user.persistence.adapter;

import com.fit.se.user.domain.aggregate.User;
import com.fit.se.user.domain.UserRepository;
import com.fit.se.user.persistence.UserPersistenceMapper;
import com.fit.se.user.persistence.SpringDataUserNeo4jRepository;

package com.fit.se.friendship.domain.aggregate;
...
public class Friendship {
    ...
    public Friendship(
        ...
        this(id, senderId, receiverId, requestedAt, FriendshipSource.DIRECT, null);
    }
    ...
    public Friendship(
        ...
        if (source == null) {
            throw new IllegalArgumentException("Friendship source must not be null");
        }

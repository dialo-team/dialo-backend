...
import com.fit.se.blocks.application.query.mine.MyBlockQuery;
import com.fit.se.blocks.application.query.mine.MyBlockQueryHandler;
import com.fit.se.friendship.application.query.mine.MyFriendQuery;
import com.fit.se.friendship.application.query.mine.MyFriendQueryHandler;
import com.fit.se.friendship.application.query.pending.MyPendingFriendRequestsQuery;
import com.fit.se.friendship.application.query.pending.MyPendingFriendRequestsQueryHandler;
import com.fit.se.friendship.application.query.pending.MySentFriendRequestsQueryHandler;
import com.fit.se.user.application.command.appearance.UpdateAppearanceCommand;
import com.fit.se.user.application.command.appearance.UpdateAppearanceCommandHandler;
import com.fit.se.user.application.command.avatar.UpdateAvatarCommand;
import com.fit.se.user.application.command.avatar.UpdateAvatarCommandHandler;
import com.fit.se.user.application.command.background.UpdateBackgroundCommand;
import com.fit.se.user.application.command.background.UpdateBackgroundCommandHandler;
import com.fit.se.user.application.command.basicinfo.UpdateBasicInfoCommand;
import com.fit.se.user.application.command.basicinfo.UpdateBasicInfoCommandHandler;
import com.fit.se.user.application.command.bio.UpdateBioCommand;
import com.fit.se.user.application.command.bio.UpdateBioCommandHandler;
import com.fit.se.user.application.command.privacy.OverridePrivacyCommand;
import com.fit.se.user.application.command.privacy.OverridePrivacyCommandHandler;
import com.fit.se.user.application.command.privacy.RemovePrivacyOverrideCommand;
import com.fit.se.user.application.command.privacy.RemovePrivacyOverrideCommandHandler;
import com.fit.se.user.application.command.privacy.UpdatePrivacyCommand;
import com.fit.se.user.application.command.privacy.UpdatePrivacyCommandHandler;
import com.fit.se.user.application.command.profile.UpdateProfileCommand;
import com.fit.se.user.application.command.profile.UpdateProfileCommandHandler;
import com.fit.se.user.application.command.qr.CustomizeQrCommand;
import com.fit.se.user.application.command.qr.CustomizeQrCommandHandler;
import com.fit.se.user.application.command.qr.RotateQrCommand;
import com.fit.se.user.application.command.qr.RotateQrCommandHandler;
import com.fit.se.user.application.query.mine.MyInfoQuery;
import com.fit.se.user.application.query.mine.MyInfoQueryHandler;
import com.fit.se.common.context.HolderContext;
import com.fit.se.user.dto.request.CustomizeQrRequest;
import com.fit.se.user.dto.request.OverridePrivacyRequest;
import com.fit.se.user.dto.request.UpdateAppearanceRequest;
import com.fit.se.user.dto.request.UpdateBasicInfoRequest;
import com.fit.se.user.dto.request.UpdateBioRequest;
import com.fit.se.user.dto.request.UpdatePrivacyRequest;
import com.fit.se.user.dto.request.UpdateProfileRequest;

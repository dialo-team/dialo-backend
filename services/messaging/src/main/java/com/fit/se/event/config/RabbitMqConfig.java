...
public class RabbitMqConfig {
    ...
    public Queue friendAcceptedQueue() {
        return new Queue("messaging.friend.accepted", true);
    }

    @Bean
    public Queue userCreatedQueue() {
        return new Queue("messaging.user.created", true);
    }
    ...
    public Binding friendAcceptedBinding(Queue friendAcceptedQueue, TopicExchange socialEventsExchange) {
        return BindingBuilder.bind(friendAcceptedQueue).to(socialEventsExchange).with("friend.accepted");
    }
